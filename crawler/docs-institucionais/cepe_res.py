...
import os
import base64
from crawler.crawler_connections import DOWNLOAD_DIR, es, create_tags, create_ato_documento, INDEX_NAME, cursor, conn

###Conselho é departamento???

# URL da página contendo as resoluções

#BASE_URL = f"https://www2.ifal.edu.br/acesso-a-informacao/institucional/orgaos-colegiados/conselho-de-ensino-pesquisa-e-extensao/resolucoes-1/{ANO}"
...
URLS = {
    '2025': 'https://www2.ifal.edu.br/acesso-a-informacao/institucional/orgaos-colegiados/conselho-de-ensino-pesquisa-e-extensao/resolucoes-1/2025',
    '2024': 'https://www2.ifal.edu.br/acesso-a-informacao/institucional/orgaos-colegiados/conselho-de-ensino-pesquisa-e-extensao/resolucoes-1/2024',
    '2023': 'https://www2.ifal.edu.br/acesso-a-informacao/institucional/orgaos-colegiados/conselho-de-ensino-pesquisa-e-extensao/resolucoes-1/2023',
    '2022': 'https://www2.ifal.edu.br/acesso-a-informacao/institucional/orgaos-colegiados/conselho-de-ensino-pesquisa-e-extensao/resolucoes-1/2022-1',
    '2021': 'https://www2.ifal.edu.br/acesso-a-informacao/institucional/orgaos-colegiados/conselho-de-ensino-pesquisa-e-extensao/resolucoes-1/2021'
}

print("Iniciando processo...")
print("Raspando PDFs da página...")

def main(ANO, BASE_URL):
    ...
    for a in content_div.find_all("a", href=True):
        if ANO == 2021:
          autor = a.find_previous('strong')
          #input(autor.get_text(strip=True))
        numero_doc = '00'
        ...
        if PDF_URL.endswith(".pdf"):
            ...
            if titulo_m.startswith('reso'): 
                ...
                tipo_doc = 11
                tipo_nome = 'Relatório'
            elif titulo_m.startswith('pp') or titulo_m.startswith('projeto'):
                tipo_doc = 20
                tipo_nome = 'Projeto'
                assunto_doc = 1
            elif titulo_m.startswith('plano'):
                tipo_doc = 21
                tipo_nome = 'Plano'
                assunto_doc = 1
            elif titulo_m.startswith('calend'):
                tipo_doc = 0
...
#        print(titulo)
    ...
    for pdf in pdfs:
        ...
        try:
            ...
            query = """
                INSERT INTO documentos (ano, titulo, numero, ementa, arquivo, tipo_documento_id, user_id, assunto_id, unidade_id)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)
            """
            cursor.execute(query, (ANO, TITULO_DOC, f'{NUMERO}/{ANO}', TITULO_DOC, elastic_id, TIPO_ID, 1, ASSUNTO_ID, UNIDADE_ID))
            conn.commit()
