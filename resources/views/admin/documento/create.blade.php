                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="range" value="{{ old('manual_score', 0) }}" class="form-control-range mr-2" id="manual_score" name="manual_score" min="0" max="1000" step="1" oninput="document.getElementById('score_val').innerText = this.value">
                                    <span id="score_val" class="badge badge-secondary" style="font-size: 14px;">{{ old('manual_score', 0) }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="switch-wrapper mt-4">
                                ...
                                <input type="checkbox" id="oficial" name="oficial" class="switch-input" value="1" {{ old('oficial') ? 'checked' : '' }}>
